...
fit <- readRDS("model-hyperbias.rds")
...
row1 <- makerow("UA Source","Military Deaths-Ukraine",(bias),"Multilevel + Hyperprior")
row2 <- makerow("UA Source","Military Deaths-Russia",(bias),"Multilevel + Hyperprior")
row3 <- makerow("RU Source","Military Deaths-Ukraine",(bias),"Multilevel + Hyperprior")
row4 <- makerow("RU Source","Military Deaths-Russia",(bias),"Multilevel + Hyperprior")
...
############################################
row1 <- makerow("Military Deaths-Ukraine",365,(unbiased_cum_mean),"Multilevel + Hyperprior")
row2 <- makerow("Military Deaths-Russia",365,(unbiased_cum_mean),"Multilevel + Hyperprior")
row3 <- makerow("Tanks-Ukraine",365,(unbiased_cum_mean),"Multilevel + Hyperprior")
row4 <- makerow("Tanks-Russia",365,(unbiased_cum_mean),"Multilevel + Hyperprior")
