...
row1 <- makerow("UA Source","Military Deaths-Ukraine",(bias),"Single Level")
row2 <- makerow("UA Source","Military Deaths-Russia",(bias),"Single Level")
row3 <- makerow("RU Source","Military Deaths-Ukraine",(bias),"Single Level")
row4 <- makerow("RU Source","Military Deaths-Russia",(bias),"Single Level")
...
############################################
row1 <- makerow("Military Deaths-Ukraine",365,(unbiased_cum_mean),"Single Level")
row2 <- makerow("Military Deaths-Russia",365,(unbiased_cum_mean),"Single Level")
row3 <- makerow("Tanks-Ukraine",365,(unbiased_cum_mean),"Single Level")
row4 <- makerow("Tanks-Russia",365,(unbiased_cum_mean),"Single Level")
