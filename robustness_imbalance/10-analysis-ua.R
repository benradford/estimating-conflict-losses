...
for(ii in 1:length(all_models))
{
  ...
  write(row1,file="biases_ua.csv",append=TRUE)
  write(row2,file="biases_ua.csv",append=TRUE)
  write(row3,file="biases_ua.csv",append=TRUE)
  write(row4,file="biases_ua.csv",append=TRUE)
  ...
  write(row1,file="cum_losses_ua.csv",append=TRUE)
  write(row2,file="cum_losses_ua.csv",append=TRUE)
  write(row3,file="cum_losses_ua.csv",append=TRUE)
  write(row4,file="cum_losses_ua.csv",append=TRUE)
